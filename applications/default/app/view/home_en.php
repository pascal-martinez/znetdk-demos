...
<div id="home_teaser">
    ...
    <ul>
        ...
        <li>The <strong>Authorizations management</strong> embedded in ZnetDK:
            <ul>
        ...
        <li>The <strong>multi-language</strong> on-screen display : translation in French, English and Spanish.</li>
        <li>The <strong>context sensitive online help</strong>.</li>
    </ul>
</div>